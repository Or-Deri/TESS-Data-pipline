...
locked down by [tests/cleaning/test_groundtruth.py](../../../../tests/cleaning/test_groundtruth.py),
which diffs the output FITS against the captured `tests/data/cleaning/groundtruth/expected/`.
...
covered by [tests/cleaning/test_strategy.py](../../../../tests/cleaning/test_strategy.py).
