...
| Numeric pin | Captured ground truth under `tests/data/cleaning/groundtruth/expected/` (see [08 Verification](08-verification.md)) |
...
captured ground-truth FITS under `tests/data/cleaning/groundtruth/expected/`.
