...
Fixtures were generated with `random.seed(0)`, `blknum=5`, `num_iterations=2`, and the compiled C OIS backend. Without `build/a.out` the test uses Python OIS and a looser residual tolerance.
