...
from .runner import _get_fits_files, dehaze
...
def build_parser():
    ...
    dehaze_cmd = sub.add_parser("dehaze", help="Run the dehazing pipeline")
    dehaze_cmd.add_argument(
        "--input-dir",
        default=None,
